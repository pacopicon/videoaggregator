      ...
      <div>
        ...
        <Row style={ row }>
          <Col xs={{ size: 4, offset: 4 }}>
            <Input type="text" name="text" style={{ width: '100%', height: '180px', fontSize: '80px'}} value={ query } onChange={this.handleRequest} />
          </Col>
          <Col xs='4'>
        ...
        <Row style={ row }>
          <Col xs={{ size: 4, offset: 4 }}>
            ...
            <Button outline color="primary" style={{ width: '100%', height: '180px', fontSize: '80px'}} onClick={ () => this.request()}>Request</Button>
          </Col>
          <Col xs='4'>
          </Col>
        </Row>
